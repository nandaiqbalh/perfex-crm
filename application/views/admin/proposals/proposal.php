            ...
            <div class="col-md-12">
                ...
                <div class="panel_s">
                    <div class="panel-body otmain-edit-form">
                        <?php
                        $proposalObj = isset($proposal) ? $proposal : null;
                        $selected    = '';
                        ...
                        $assignedSelected = ! isset($proposal) && get_option('automatically_set_logged_in_staff_sales_agent') == '1' ? get_staff_user_id() : '';
                        foreach ($staff as $member) {
                            if (isset($proposal) && $proposal->assigned == $member['staffid']) {
                                $assignedSelected = $member['staffid'];
                            }
                        }
                        $statusDisabled = '';
                        if (isset($proposal) && ($proposal->estimate_id != null || $proposal->invoice_id != null)) {
                            ...
                            <div class="col-md-6 otmain-col-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        } elseif (get_option('proposal_due_after') != 0) {
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group select-placeholder">
                                            <label for="status" class="control-label"><?= _l('proposal_status'); ?></label>
                                    ...
                                    <div class="col-md-6">
                                        <?= render_select('assigned', $staff, ['staffid', ['firstname', 'lastname']], 'proposal_assigned', $assignedSelected); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 otmain-col-right">
                                <?php otmain_proposal_section('document', $proposalObj); ?>
                            </div>
                        </div>
                                ...
                                <div
                                    ...
                                    <div id="project_ajax_search_wrapper">
                                        <select name="project_id" id="project_id" class="projects ajax-search"
                                            ...
                                            data-none-selected-text="<?= _l('dropdown_non_selected_tex'); ?>">
                                            <?php if (isset($proposal) && $proposal->project_id) {
                            ...
                            <div class="col-md-6 otmain-col-right">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php $selectedCountry = (isset($proposal) ? $proposal->country : ''); ?>
                                        <?= render_select('country', $countries, ['country_id', ['short_name'], 'iso2'], 'billing_country', $selectedCountry); ?>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 otmain-col-right">
                                <?php otmain_proposal_section('contact', $proposalObj); ?>
                            </div>
                        </div>
                        <?php otmain_form_section_close(); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 otmain-col-right">
                                <?php otmain_proposal_section('terms', $proposalObj); ?>
                            </div>
                        </div>
                        <?php otmain_form_section_close(); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 otmain-col-left">
                                ...
                                <div class="form-group mtop10 no-mbot">
                                    <p><?= _l('proposal_allow_comments'); ?></p>
                            ...
                            <div class="col-md-6 otmain-col-right">
                                <?php otmain_proposal_section('extras', $proposalObj); ?>
                                <?php otmain_proposal_section('notes', $proposalObj); ?>
                            </div>
                        </div>
                        <?php otmain_form_section_close(); ?>
                        <div
