...
<div class="form-group">
    ...
    <div class="radio radio-primary radio-inline">
        <input type="radio" name="settings[invoice_number_format]" value="6" id="i_otmain_format"
            <?= get_option('invoice_number_format') == '6' ? 'checked' : '' ?>>
        <label for="i_otmain_format">YYYY-INV-NNN (OT-Main)</label>
    </div>
    <hr />
</div>
