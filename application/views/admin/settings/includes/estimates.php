...
<div class="form-group">
    ...
    <div class="radio radio-primary radio-inline">
        <input type="radio" name="settings[estimate_number_format]" value="5" id="e_otmain_format"
            <?= get_option('estimate_number_format') == '5' ? 'checked' : '' ?>>
        <label for="e_otmain_format">DD-YYYY-OTMSQ-NNN (OT-Main)</label>
    </div>
    <hr />
</div>
<div class="row">
