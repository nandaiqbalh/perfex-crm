        ...
        <div class="row">
            ...
            <div class="col-md-6">
               ...
               if ($format == 1) {
                   ...
                   $prefix = date('d', strtotime(isset($estimate) ? $estimate->date : date('Y-m-d'))) . '-' . date('Y', strtotime(isset($estimate) ? $estimate->date : date('Y-m-d'))) . '-' . get_option('estimate_prefix');
               }
             ...
             ?>
                ...
                <?php hooks()->do_action('otmain_estimate_form_fields', $estimate ?? null); ?>
            </div>
            <div class="col-md-6">
                <div class="tw-ml-3">
                    <div class="form-group">
