 ...
 * Source: 2025-INV-108 — Projectleider-VU- Bergen
 * Client Ref.: 25.1000266.1.0058
 * No CRM quotation link (Quote Ref = project/job name).
 */
return [
    'key'                   => 'ps_inv_108',
    'source_invoice_number' => '2025-INV-108',
    'source_quote_ref'      => 'Projectleider-VU- Bergen',
    'customer_company'      => 'Projectservice Nederland B.V.',
    'force_status'          => 1,
    'save_option'           => 'otmain_seed_invoice_ps_inv_108',
    'invoice' => [
        'number'               => 108,
        'date'                 => '2025-01-30',
        'duedate'              => '2025-03-01',
        ...
        'invoice_title'        => 'Projectleider-VU- Bergen',
        'adminnote'            => 'PDF Invoice Number: 2025-INV-108<br />Quote Ref.: Projectleider-VU- Bergen<br />Client Ref.: 25.1000266.1.0058',
        ...
        'newitems'             => [
            1 => [
                'description'      => 'Uren tarief Projectleider - VU - Bergen',
                'long_description' => "Inclusief reistijd minus 30 min\n\nBegintijd Heenreis rijden: 16:23\nStart tijd werkzaamheden: 17:58\nEind tijd werkzaamheden: 22:01\nAankomsttijd Terugreis rijden: 23:13",
                'qty'              => 6.33,
                'rate'             => 30.00,
                'unit'             => '',
                'taxname'          => ['VAT|21'],
