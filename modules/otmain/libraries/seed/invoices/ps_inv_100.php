 ...
 * Source: 2025-INV-100 — Projectleider-VU - Pijnacker
 * Client Ref.: 25.1000266.1.0028
 * No CRM quotation link (Quote Ref = project/job name).
 */
return [
    'key'                   => 'ps_inv_100',
    'source_invoice_number' => '2025-INV-100',
    'source_quote_ref'      => 'Projectleider-VU - Pijnacker',
    'customer_company'      => 'Projectservice Nederland B.V.',
    'force_status'          => 1,
    'save_option'           => 'otmain_seed_invoice_ps_inv_100',
    'invoice' => [
        'number'               => 100,
        'date'                 => '2025-01-21',
        'duedate'              => '2025-02-20',
        ...
        'invoice_title'        => 'Projectleider-VU - Pijnacker',
        'adminnote'            => 'PDF Invoice Number: 2025-INV-100<br />Quote Ref.: Projectleider-VU - Pijnacker<br />Client Ref.: 25.1000266.1.0028',
        ...
        'newitems'             => [
            1 => [
                'description'      => 'Uren tarief Projectleider - VU - Pijnacker',
                'long_description' => "Inclusief reistijd minus 30 min\n\nBegintijd Heenreis rijden: 16:38\nStart tijd werkzaamheden: 17:10\nEind tijd werkzaamheden: 21:46\nAankomsttijd Terugreis rijden: 22:15",
                'qty'              => 5.12,
                'rate'             => 30.00,
                'unit'             => '',
                'taxname'          => ['VAT|21'],
