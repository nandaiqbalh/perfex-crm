...
<div class="panel_s">
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-md-4"><?php echo render_date_input('date', 'date', isset($pl) ? _d($pl->date) : _d(date('Y-m-d'))); ?></div>
            <div class="col-md-8"><?php echo render_input('vessel', 'otmain_vessel', $pl->vessel ?? ''); ?></div>
            <div class="col-md-6">
                <h5 class="bold"><?php echo _l('otmain_consignee'); ?></h5>
            ...
            <div class="col-md-6">
                <h5 class="bold"><?php echo _l('otmain_purchaser'); ?></h5>
        ...
        <hr />
        <h5 class="bold"><?php echo _l('otmain_packing_invoice_items'); ?></h5>
