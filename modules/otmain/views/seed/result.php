            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <hr />
                        <p class="text-muted">
                            Seed <strong>hanya mengganti dokumen yang pernah di-seed</strong> (tracked di <code>otmain_seed_document_ids</code>).
                            Customers di-upsert; dokumen manual lain tidak disentuh.
